#' @title Kriging direccional 2D y 3D
#' @description Esta funcion permite hacer prediccion por medio de kriging direccional, para muestras 2D y 3D
...
#' @examples
#' @export
kriging_dir=function(sondajes,coordenadas.sondajes,variable,
