#' @title Validacion cruzada omnidireccional 2D y 3D
#' @description Esta funcion permite realizar validacion cruzada por medio de kriging omnidireccional, para muestras 2D y 3D
...
#' @param max.num.pares corresponde al numero maximo de vecinos para realizar la prediccion
#' @details Esta funcion sirve para sondajes 2D o 3D
#' @examples
#' @export
valid_omni=function(sondajes,coordenadas.sondajes,variable,
